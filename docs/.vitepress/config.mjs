          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { text: '💎 for循环专题练习', link: '/programming/cpp-v2/gesp-for-loop-pro.html' },
                { text: '💎 switch专题练习', link: '/programming/cpp-v2/gesp-switch-pro.html' },
                { text: '💎 if嵌套专题练习', link: '/programming/cpp-v2/gesp-if-nested-pro.html' },
                { text: '💎 if多分支专题练习', link: '/programming/cpp-v2/gesp-if-multi-pro.html' },
                { text: '💎 if双分支专题练习', link: '/programming/cpp-v2/gesp-if-double-pro.html' },
                { text: '💎 if单分支专题练习', link: '/programming/cpp-v2/gesp-if-single-pro.html' },
                { text: '💎 复合运算符专题练习', link: '/programming/cpp-v2/gesp-compound-operators-pro.html' },
